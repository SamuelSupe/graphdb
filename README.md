...
The latest published release is GGraphDB 1.0:
[**v1.0.0**](https://github.com/SamuelSupe/graphdb/releases/tag/v1.0.0).
This branch is the GGraphDB 1.1 release candidate; it is GA only after the
release checklist and 30-minute PostgreSQL CAS gate pass for the tag.
