...
- `graphdb-v1.1.0.tar.gz`: binaries, SDKs, docs, examples, and Compose files.
- `graphdb-v1.1.0.tar.gz.sha256`: SHA-256 checksum.

Verify and unpack:

```sh
sha256sum -c graphdb-v1.1.0.tar.gz.sha256
tar -xzf graphdb-v1.1.0.tar.gz
cd graphdb-v1.1.0
```
