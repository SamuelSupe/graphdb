...
roll back GGraphDB 1.1. Examples use the released `v1.1.3` tag, available at
<https://github.com/SamuelSupe/graphdb/releases/tag/v1.1.3>.

## 1. Download and verify

The release page provides:

- `graphdb-v1.1.3.tar.gz`: binaries, SDKs, docs, examples, and Compose files.
- `graphdb-v1.1.3.tar.gz.sha256`: SHA-256 checksum.

Verify and unpack:

```sh
sha256sum -c graphdb-v1.1.3.tar.gz.sha256
tar -xzf graphdb-v1.1.3.tar.gz
cd graphdb-v1.1.3
```
