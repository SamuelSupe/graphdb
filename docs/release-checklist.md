# GGraphDB 1.3.4 Release Checklist
...
The v1.3.4 patch preserves the existing WAL record format. Local verification
...
- [ ] Go and Python SDKs are version `1.3.4` and preserve direct `200/207`
